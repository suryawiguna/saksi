      ...
      <div class="row">
        ...
        <br><br>
          ...
          <div class="col">
            <div class="row">
              <div class="col-md-4">
                <form class="" action="/kab/{{$kabNow->id}}/search" method="POST" role="search">
                  {{ csrf_field() }}
              ...
              <div class="col-md text-left">
                <a class="btn btn-outline-dark" href="/cetak/kab/{{$kabNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
              </div>
            </div>
            <br>
              ...
              <table id="example" class="table table-stripped table-bordered table-hover">
                ...
                <tbody>
                @foreach($saksiKabs as $x=>$saksiKab)
                  <tr>
                    <td>{{$x+1}}</td>
                    ...
                    <td><a href="/profilkoor/{{$saksiKab->id_koor}}" class="text-dark">{{$saksiKab->koor->nama_koor}}</a></td>
                    ...
                    <td><a href="{{\Storage::url($saksiKab->foto_diri)}}"><img src="{{\Storage::url($saksiKab->foto_ktp)}}" class="img-fluid"></a></td>
                  </tr>

    ...
    <div class="container-fluid py-5 mt-4">
      <div class="row">
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="/kec/{{$kecNow->id}}/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="col-md text-left">
              <a class="btn btn-outline-dark" href="/cetak/kec/{{$kecNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
            </div>
          </div>
          <br>

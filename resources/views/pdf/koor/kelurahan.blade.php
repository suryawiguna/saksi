    ...
    <head>
        ...
        <body>
            ...
            <div style="font-family:Arial; font-size:12px;">
              ...
              <center>
                <h4>Kelurahan/Desa: <strong>{{$kelNow->nama_kelurahandesa}}</strong>, Kecamatan: <strong>{{$kecNow->nama_kecamatan}}</strong>, Kabupaten/Kota: <strong>{{$kabNow->nama_kabupatenkota}}</strong>, Provinsi: <strong>Bali</strong></h4>
              </center>
            </div>

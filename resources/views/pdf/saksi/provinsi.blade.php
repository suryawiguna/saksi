    ...
    <head>
        ...
        <body>
            ...
            <div style="font-family:Arial; font-size:12px;">
              ...
              <center>
                <h4>Provinsi: <strong>Bali</strong></h4>
              </center>
            </div>
            ...
            <table class="tg">
              <tr>
                ...
                <th class="tg-3wr7">Kabupaten / Kota<br></th>
                <th class="tg-3wr7">Kecamatan<br></th>
              ...
              <tr>
                ...
                <td class="tg-rv4w" width="30%">{{$data->kabupatenKota->nama_kabupatenkota}}</td>
                <td class="tg-rv4w" width="30%">{{$data->kecamatan->nama_kecamatan}}</td>

              ...
              <div class="card rounded-0">
                <div class="card-header">
                  ...
                  <ul class="nav nav-pills nav-fill">
                    <li class="nav-item">
                      <a class="nav-link" href="/tamu/login">Login Tamu</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active" href="/login">Login Kecamatan</a>
                    </li>
                  </ul>
                </div>
                <div class="card-body">
                  <h2 class="text-center">Login <strong>Kecamatan</strong></h2><br>

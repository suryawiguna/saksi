  ...
  <body>
    ...
    <div class="container-fluid py-5 mt-4">
      ...
      <div class="col">
        <div class="row">
          <div class="col-md-4">
            <form class="" action="/lihatkoor/search" method="POST" role="search">
              {{ csrf_field() }}
          ...
          <div class="col-md text-left">
            <a class="btn btn-outline-dark" href="/lihatkoor/cetak/provinsi" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
          </div>
        </div>
        <br>
            ...
            <table id="example" class="table table-stripped table-bordered table-hover">
              ...
              @foreach($koors as $x=>$koor)
                <tr>
                  ...
                  <td><a href="/profilkoor/{{$koor->id}}" class="text-dark">{{$koor->nama_koor}}</a></td>
                  <td>{{$koor->alamat}}</td>
                  <td>{{$koor->no_hp}}</td>

    ...
    <div class="container-fluid py-5 mt-4">
      <div class="row">
          ...
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-10 col-md-12 col-sm-12 mx-auto">
                <div class="row">
                  <div class="col-lg col-md col-sm-6 py-2">
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="/admin/kab/{{$idKab}}/kec/{{$idKec}}/kel/{{$idKel}}/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="col-md text-left">
              <a class="btn btn-outline-dark" href="/admin/cetak/kab/{{$idKab}}/kec/{{$idKec}}/kel/{{$idKel}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
            </div>
          </div>
          <br>
          ...
          <div class="table-responsive">
            <table class="table table-stripped table-bordered table-hover">
              ...
              <?php $no++ ;?>
                <tr>
                  <td>{{$no}}</td>
                  <td>{{$saksiKel->kab_kota}}</td>
                  <td>{{$saksiKel->kecamatan}}</td>
                  <td>{{$saksiKel->desa}}</td>
                  <td>{{$saksiKel->no_tps}}</td>
                  <td><a href="/profilkoor/{{$saksiKel->kab_kota}}/{{$saksiKel->kecamatan}}/{{$saksiKel->desa}}/{{$saksiKel->nama_koor}}" class="text-dark">{{$saksiKel->nama_koor}}</a></td>
                  <td>{{$saksiKel->partai}}</td>

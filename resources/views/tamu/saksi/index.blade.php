      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="col">
            <div class="row">
              <div class="col-md-4">
                <form class="" action="/tamu/search" method="POST" role="search">
                  {{ csrf_field() }}
              ...
              <div class="col-md text-left">
                <a class="btn btn-outline-dark" href="/tamu/cetak/provinsi" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
              </div>
            </div>
            <br>
                ...
                <div class="table-responsive">
                  <table class="table table-stripped table-bordered table-hover">
                    ...
                    @foreach($saksis as $saksi)
                      <tr>
                        <td>{{(($saksis->currentPage() - 1 ) * $saksis->perPage() ) + $loop->iteration}}</td>
                        ...
                        <td>{{$saksi->no_tps}}</td>
                        <td><a href="/tamu/profilkoor/{{$saksi->id_koor}}" class="text-dark">{{$saksi->koor->nama_koor}}</a></td>

    ...
    <div class="container-fluid py-5 mt-4">
      <div class="row">
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="/tamu/kel/{{$kelNow->id}}/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="col-md text-left">
              <a class="btn btn-outline-dark" href="/tamu/cetak/kel/{{$kelNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
            </div>
          </div>
          <br>
            ...
            <table class="table table-stripped table-bordered table-hover">
              ...
              @foreach($saksiKels as $saksiKel)
                <tr>
                  ...
                  <td><a href="/tamu/profilkoor/{{$saksiKel->id_koor}}" class="text-dark">{{$saksiKel->koor->nama_koor}}</a></td>

  ...
  <body>
    ...
    <div class="container-fluid py-5 mt-4">
      ...
      <div class="col">
        <div class="row">
          <div class="col-md-4">
            <form class="" action="/tamu/lihatkoor/kab/{{$kabNow->id}}/search" method="POST" role="search">
              {{ csrf_field() }}
          ...
          <div class="col-md text-left">
            <a class="btn btn-outline-dark" href="/tamu/lihatkoor/cetak/kab/{{$kabNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
          </div>
        </div>
        <br>
            ...
            <table class="table table-stripped table-bordered table-hover">
              ...
              @foreach($koorKabs as $koorKab)
                <tr>
                  ...
                  <td><a href="/tamu/profilkoor/{{$koorKab->id}}" class="text-dark">{{$koorKab->nama_koor}}</a></td>

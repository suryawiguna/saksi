    ...
    <div class="container-fluid py-5 mt-4">
      <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-lg col-md col-sm py-2">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownKec">
                        @foreach($kecs as $kec)
                        <a class="dropdown-item" href="/tamu/lihatkoor/kec/{{$kec->id}}">{{$kec->nama_kecamatan}}</a>
                        @endforeach
                      </div>
                    </div>
                  </div>
                  <div class="col-lg col-md col-sm py-2">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownKec">
                        @foreach($kels as $kel)
                        <a class="dropdown-item" href="/tamu/lihatkoor/kel/{{$kel->id}}">{{$kel->nama_kelurahandesa}}</a>
                        @endforeach
                      </div>
                    </div>
                  </div>
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="/tamu/lihatkoor/kec/{{$kecNow->id}}/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="col-md text-left">
              <a class="btn btn-outline-dark" href="/tamu/lihatkoor/cetak/kec/{{$kecNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
            </div>
          </div>
          <br>
            ...
            <table class="table table-stripped table-bordered table-hover">
              ...
              @foreach($koorKecs as $koorKec)
                <tr>
                  ...
                  <td>{{$koorKec->kabupatenKota->nama_kabupatenkota}}</td>
                  <td>{{$koorKec->kecamatan->nama_kecamatan}}</td>
                  <td>{{$koorKec->kelurahanDesa->nama_kelurahandesa}}</td>
                  <td><a href="/tamu/profilkoor/{{$koorKec->id}}" class="text-dark">{{$koorKec->nama_koor}}</a></td>

    ...
    <div class="container-fluid py-5 mt-4">
      <div class="row">
        ...
        <div class="col">
          <div class="row">
            <div class="col-md-4">
              <form class="" action="/tamu/lihatkoor/kel/{{$kelNow->id}}/search" method="POST" role="search">
                {{ csrf_field() }}
            ...
            <div class="col-md text-left">
              <a class="btn btn-outline-dark" href="/tamu/lihatkoor/cetak/kel/{{$kelNow->id}}" role="button"><i class="mdi mdi-printer"></i> Cetak</a>
            </div>
          </div>
          <br>
            ...
            <table class="table table-stripped table-bordered table-hover">
              ...
              @foreach($koorKels as $koorKel)
                <tr>
                  ...
                  <td><a href="/tamu/profilkoor/{{$koorKel->id}}" class="text-dark">{{$koorKel->nama_koor}}</a></td>
